<template>
  ...
  /**
   * PipelineLineagePanel Component
   * 
   * This component serves as the dedicated panel for displaying pipeline lineage data.
   */
  ...
  const handleMessage = (event) => {
    ...
    if (message.panelType !== "PipelineLineage") return;
