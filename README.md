...
### Recent Update
- **0.81.3**: Recognized Tableau assets and synced the full set of Bruin CLI asset types, fixing validation errors and missing autocompletion for newer types. Added `npm run sync:asset-types` to keep the schema in sync with the Bruin CLI.
